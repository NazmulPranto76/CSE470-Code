...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        ImageIcon bun  = new ImageIcon(ClassLoader.getSystemResource("icons/bracu_logo.png"));
        Image b2un = bun.getImage().getScaledInstance(128,128,Image.SCALE_DEFAULT);
        ImageIcon b3un = new ImageIcon(b2un); 
        JLabel NewLabeln = new JLabel(b3un);
        NewLabeln.setBounds(0, 0, 2450, 210); 
        add(NewLabeln);
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel AirlineManagementSystem = new JLabel("Welcome to BRAC Hotel");
	AirlineManagementSystem.setForeground(new Color(0, 0, 0));
        AirlineManagementSystem.setFont(new Font("Cursive", Font.PLAIN, 46));
